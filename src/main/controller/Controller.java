...
//		scrollPanel.setHmin(0);
		// cssStyleSheet = getClass().getResource("application.css").toString();

		Image image1 = new Image(getClass().getResource("../../resources/images/logoutS.png").toString());
		if (image1.isError()) {
			System.err.println("Error loading the image: " + image1.getException().getMessage());
		}
		Image newUserImage = new Image(getClass().getResource("../../resources/images/newUserIcon32.png").toString());
		...
		Image flip = new Image(getClass().getResource("../../resources/images/flipId_32.png").toString());
		if (flip.isError()) {
	...
	public void setAccounts() {
		...
		for (Account ac : accounts) {
			if (first) {
				ac.setImageS(getClass().getResource("../../resources/images/myImage (Custom).png").toString());
				ac.setImageL(getClass().getResource("../../resources/images/myImage.png").toString());
				...
				ac.setImageS(getClass().getResource("../../resources/images/users64_icon.png").toString());
				ac.setImageL(getClass().getResource("../../resources/images/users_icon.png").toString());
				ac.setImageFIdPath(getClass().getResource("../../resources/images/imageNotAvailable.png").toString());
				ac.setImageBIdPath(getClass().getResource("../../resources/images/imageNotAvailable.png").toString());
			}
		}
